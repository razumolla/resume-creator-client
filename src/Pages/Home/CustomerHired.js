...
import facebook from '../Assets/Images/rsz_1images.png'
import bbc from '../Assets/Images/rsz_download.jpg'
            ...
            <div className='flex justify-center gap-10 my-10'>
                ...
                <a href="https://www.google.com"><img src={google} alt="" className="" /></a>
                    <div class="opacity-0 h-50 group-hover:opacity-100 group-hover:h-full ">
                        <span className='text-orange-500'>Hired by Google</span>
                    </div>
                </div>
                <div class="group" >
                ...
                <div class="group" >
                <a href="https://www.apple.com/"><img src={apple} alt="" className="" /></a>
                    <div class="opacity-0 h-50 group-hover:opacity-100 group-hover:h-full ">
                        <span className='text-orange-500'>Hired by Apple</span>
                    </div>
                </div>
                <div class="group" >
                <a href="https://www.bbc.com/"><img src={bbc} alt="" className="" /></a>
                    <div class="opacity-0 h-50 group-hover:opacity-100 group-hover:h-full ">
                        <span className='text-orange-500'>Hired by BBC</span>
                    </div>
                </div>
                <div class="group" >
                    <a href="https://web.facebook.com/"><img src={facebook} alt="" className="" /></a>
                    <div class="opacity-0 h-50 group-hover:opacity-100 group-hover:h-full ">
